      ...
      <div class="d-flex justify-content-center align-items-center h-100 ">
        <div class="text-white">
          ...
          <div class="row p-0 d-flex text-center justify-content-center mt-5">
            <div class="col-12 m-0"> <a href="{{route('prepara.show', $item->id)}}" class="btn btn-success rounded-pill text-uppercase  btn-lg">Preparar pedido y seleccionar ingredientes</a> </div>
          </div>
        </div>
      </div>
    </div>
