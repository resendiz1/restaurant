    ...
    <div class="row m-3 shadow p-2 justify-content-around myborder" style="background-color: lightcoral;">
      ...
      <div class="col-lg-12 col-md-12 p-3 text-center  bg-white ">
        ...
        <div class="row font-weight-bold d-flex justify-content-center" id="back">
          <div class="col-auto shadow m-2 p-2 bg-primary text-white border border-primary text-center ingrediente btn-sm">Espinacas salteadas con sal</div>
          <div class="col-auto shadow m-2 p-2 bg-warning text-white border border-primary text-center ingrediente btn-sm">Maiz frijolero del campo</div>
      ...
      <div class="col-8">
        <button class="btn btn-success btn-block"><h5>Lanzar pedido</h5></button>
      </div>
    </div>
